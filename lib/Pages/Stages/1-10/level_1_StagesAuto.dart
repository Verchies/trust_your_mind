...
import 'package:trust_your_mind/Pages/Stages/11-20/level_2_StagesAuto.dart';
...
class level_1_Stages extends StatefulWidget {
  level_1_Stages({Key? key}) : super(key: key);

  @override
  State<level_1_Stages> createState() => _level_1_StagesState();
}

class _level_1_StagesState extends State<level_1_Stages>
...
*/
  ...
  void win() {
    Future.delayed(const Duration(milliseconds: 31), () {
      if (mainPage.points == 0 &&
          mainPage.levelUp <= materials.level1 &&
  ...
  navigator() {
    Future.delayed(const Duration(milliseconds: 100), () {
      if (mainPage.points == 0) {
        if (mainPage.levelUp == materials.level1) {
          if (mainPage.showTutorial == true) {
            tutorialAlert();
            showGeneralDialog(
              barrierLabel: "label",
            ...
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => level_2_Stages()));
          }
        } else {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => level_1_Stages()));
        }
        scoreBalance();
        saveScore();
        loadScores();
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: AbsorbPointer(
                    absorbing: mainPage.boxTimer ? false : true,
                    child: Column(
                      children: [
                        Row(
