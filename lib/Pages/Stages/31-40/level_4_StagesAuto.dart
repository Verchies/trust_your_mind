...
import 'package:trust_your_mind/Material/fakebox2.dart';
...
class level_4_Stages extends StatefulWidget {
  const level_4_Stages({Key? key}) : super(key: key);

  @override
  State<level_4_Stages> createState() => _level_4_StagesState();
}

class _level_4_StagesState extends State<level_4_Stages>
  ...
  void win() {
    Future.delayed(const Duration(milliseconds: 31), () {
      if (mainPage.points == 0 && mainPage.sounds == true) {
      ...
      if (mainPage.points == 0) {
        ...
        mainPage.levelUp == materials.level3
            ? Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => const level_4_Stages()))
